...
function HomePage() {
    ...
    return (
        <div className='container'>
            ...
            <div id="total">
                <button className="light-button" onClick={() => navigate('/MCalc', { state: { list, kinship: sections.kinship } })}>بدء عملية الحساب</button> <br />
                {text}
            </div>
            ...
            <table style={{marginBottom:'50px', width:'100%'}}>
                    ...
                    <tr>
                        <td colSpan={2}>
                            <label style={{margin:'0 6px'}}>
                                <input type="checkbox" checked={sections.marriage} readOnly/>
                                الزواج
                            </label>
                        </td>
                    </tr>
                ...
                {<thead onClick={() => toggleSection('branches')}>
                    <tr>
                        <td colSpan={2}>
                            <label style={{margin:'0 6px'}}>
                                <input type="checkbox" checked={sections.branches} readOnly/>
                                &nbsp;الفروع
                            </label>
                        </td>
                    </tr>
                ...
                {<thead onClick={() => toggleSection('roots')}>
                    <tr>
                        <td colSpan={2}>
                            <label style={{margin:'0 6px'}}>
                                <input type="checkbox" checked={sections.roots} readOnly/>
                                &nbsp;الأصول
                            </label>
                        </td>
                    </tr>
                ...
                {<thead onClick={() => toggleSection('siblings')}>
                    <tr>
                        <td colSpan={2}>
                            <label style={{margin:'0 6px'}}>
                                <input type="checkbox" checked={sections.siblings} readOnly/>
                                &nbsp;الإخوة
                            </label>
                        </td>
                    </tr>
                ...
                {<thead onClick={() => toggleSection('uncle')}>
                    <tr>
                        <td colSpan={2}>
                            <label style={{margin:'0 6px'}}>
                                <input type="checkbox" checked={sections.uncle} readOnly/>
                                &nbsp;العمومة
                            </label>
                        </td>
                    </tr>
                ...
                {<thead onClick={() => toggleSection('obedience')}>
                    <tr>
                        <td colSpan={2}>
                            <label style={{margin:'0 6px'}}>
                                <input type="checkbox" checked={sections.obedience} readOnly/>
                                &nbsp;الولاء
                            </label>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colSpan={2}>
                            <label style={{margin:'0 6px', opacity: kinshipDisabled ? 0.6 : 1}}>
                                <input type="checkbox" checked={sections.kinship} disabled={kinshipDisabled} readOnly/>
                                &nbsp;ذوي الأرحام 
                            </label>
                        </td>
                    </tr>
                ...
                {sections.kinship && (<tbody>
                        ...
                        <tr>
                            ...
                            <td><button onClick={() => { Add({ nickname: 'أم أب الأب', name: 'أب الأب', gen: -3, con: 'root', rel: "Father Side", sex: "female" }) }}>{list.filter(data => data.name == 'أم أب الأب').length > 0 ? `أم أب الأب x ${list.filter(data => data.name == 'أم أب الأب').length}` : 'أم أب الأب'}</button></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td><button onClick={() => { Add({ nickname: 'أم أب الأم', name: 'الأم', gen: -3, con: 'root', rel: "Mother Side", sex: "female" }) }}>{list.filter(data => data.name == 'أم أب الأم').length > 0 ? `أم أب الأم x ${list.filter(data => data.name == 'أم أب الأم').length}` : 'أم أب الأم'}</button></td>
                        </tr>
                        <tr>
