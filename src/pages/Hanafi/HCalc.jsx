...
// the neglect measurement
  ...
  },[breaking, calculation, decreament, group, increament, inheritageA, inheritageL, inheritageM, kinship, list]);

  return (
    <div className='container'>
      <button className="light-button" onClick={() => navigate('/Hanafi', { state: { fist:list } })}>العودة لصفحة الإختيار</button>
      <div id="items">
        <table>
